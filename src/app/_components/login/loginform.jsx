...
const loginform = ({ redirectedFrom }) => {
  return (
    <section className={styles.loginformcontainer}>
      <div className={styles.form}>
        ...
        <form action={oauthSigninAction} className={styles.gitform}>
          {redirectedFrom && (
          ...
          <button className={styles.gitbtn}>
            ...
            <p className={`${styles.gittext} ${gantari.className}`}>
              Sign in with Github
            </p>
          </button>
        </form>
        <form className={styles.noaccount}>
